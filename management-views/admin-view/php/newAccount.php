<?php
    ...
    function process_array($conn,$new_account){
        ...
        $vals[count($vals)-1] = password_hash($vals[count($vals)-1],PASSWORD_BCRYPT);
    ...
    if(isset($_POST['input'])){
        ...
        $sql = "INSERT INTO users(__KEY__,agency,first_name,last_name,email,type_of_user,pass) VALUES($new_account)";
